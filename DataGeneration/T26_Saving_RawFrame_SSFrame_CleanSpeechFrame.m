%{
===========================================================================
# Aim: Data Generation From TIMIT Database
Note:
===========================================================================
%}
...
[speechnoisemix_frames, ~, ~] = normalisematrix(speechnoisemix_frames);
[SS_frames, ~, ~] = normalisematrix(SS_frames);
[cleanspeechframes, ~, ~] = normalisematrix(cleanspeechframes);
...
% saving
% !!!!!!!!!!!!!!!!!!!!!! CHANGE TO PATH TO WHICH YOU WANT TO WRITE THE DATASET
directorypath = "/Users/vrsreeganesh/Desktop/BUClasses/Thesis/Data/Dataset16_RawFrame_SSFrame_CleanSpeechFrame/";
tensortitle = directorypath+"datamatrix_"+paramstring+timeasstring+".mat";
save(tensortitle, "speechnoisemix_frames", "SS_frames", "cleanspeechframes");
